...
export function Portfolio() {
  ...
  const renderCard = (project: Project, idx: number) => {
    ...
    return (
      <div
        key={`project-${idx}`}
        className="w-[80vw] sm:w-[500px] lg:w-[600px] shrink-0 group flex flex-col"
      >
  ...
  return (
    <section id="portfolio" aria-label="Portfolio">
      ...
      <div
        ref={targetRef}
        className="hidden md:block relative bg-white h-[200vh]"
      >
        <div className="sticky top-0 h-screen flex flex-col justify-center overflow-hidden pt-20">
          ...
          <div className="flex pl-10 lg:pl-16 relative">
            <motion.div style={{ x }} className="flex gap-12 w-max">
